...
面试导向的文生视频工程实践仓库。目标：在免费或小显存 GPU 上复现并展示以下能力：
...
## 面试展示建议
1. 展示采样器与 σ 调度代码 → 指标表。
2. 展示 CFG schedule/rescale 实现与前后对比帧。
3. 展示分镜 DSL JSON 与多镜头合成视频。
4. 说明时序一致性策略（相关噪声、滑窗、插帧）。
5. 展示种子重现与版本化配置。
...
> 说明：部分模块为占位/骨架，面试中可阐述改进空间与真实实现方向.